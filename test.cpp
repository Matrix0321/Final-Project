...
// Helper function to turn BIgint object to string
...
void Tests() {
    ...
    try {
        if (number2 != -1234567890123456789LL) 
        {
            cout << "Succeeded: comparision operator '!='" << endl;
        } 
        else 
